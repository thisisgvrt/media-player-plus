...
import RecognizedPeopleContainer from '../components/RecognizedPeopleContainer';
  ...
  return (
    <>
      ...
      <div className="h-screen w-screen grid grid-rows-4 grid-cols-8 gap-2">
        <div className="row-start-2 row-span-2 col-start-1 col-span-2">
          <RecognizedPeopleContainer isPlaying={isPlaying} setPlayingStatus={setPlayingStatus} timeStamp={timeStamp} setTimeStamp={setTimeStamp}/>
        </div>
